# COMPLETE ALTIUM DELPHISCRIPT REFERENCE

*Everything you need to write DelphiScript for Altium*

*Extracted from 128 working examples - 100% verified*
...
### Part 1: Delphi Standard Library

- [Built-in Functions](#delphi-built-in-functions) - IntToStr, ShowMessage, Format, etc.

- [Built-in Types](#delphi-built-in-types) - TStringList, TList, TObjectList, etc.


### Part 2: Altium API

- [Quick Reference](#quick-reference) - Most common operations

- [PCB API](#pcb-api) - Board, Component, Track, Via, etc.

- [Schematic API](#schematic-api) - Sheet, Component, Pin, Iterator, etc.

- [Complete API Reference](#complete-altium-api) - All 89 types
